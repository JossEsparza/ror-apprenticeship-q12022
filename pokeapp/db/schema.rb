...
ActiveRecord::Schema.define(version: 2022_01_26_054049) do
  ...
  create_table "sprite_sets", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["sprites_on_id", "sprites_on_type"], name: "index_sprite_sets_on_sprites_on_id_and_sprites_on_type"
  end
  ...
  create_table "variants", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["pokemon_id"], name: "index_variants_on_pokemon_id"
  end

  add_foreign_key "ability_pokemons", "abilities"
  add_foreign_key "ability_pokemons", "pokemons"
  add_foreign_key "variants", "pokemons"
end
